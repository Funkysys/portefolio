...
const Contact = () => {
  const skills = [
    ...
    { category: "Backend", items: ["Node.js", "Express", "MongoDB", "SQL", "API REST"] },
    { category: "Outils", items: ["Git", "VS Code", "Docker", "Figma", "Postman"] },
  ];
  ...
  const socialLinks = [
    ...
    { name: "Email", url: "mailto:votre@email.com", icon: (
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        ...
        >
          ...
          <p className="text-lg text-gray-300 leading-relaxed">
            Passionné par le développement web et les nouvelles technologies, je crée des expériences numériques
            uniques et immersives. Mon approche combine créativité et expertise technique pour donner vie à vos projets.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h3 className="text-2xl font-bold text-white mb-8 text-center">Compétences</h3>
