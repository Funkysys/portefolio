const MentionsLegales = () => (
  <main className="max-w-3xl mx-auto px-4 py-10  bg-gradient-to-br from-cyan-950 to-cyan-900 text-cyan-50">
    ...
    <section className="mb-8">
      ...
      <p>
        ...
        <br />
        Prestations et Services : vercel.com met à disposition des Clients :
        ...
        détenues par vercel.com pour la gestion de votre compte, de la gestion
    ...
    <section className="mb-8">
      ...
      <p>
        ...
        site internet https://antoinedelbos-portefolio.vercel.app/ l’identité
        des différents intervenants dans le cadre de sa réalisation et de son
        suivi:
        <br />
        Propriétaire : Julien Dahy – 46 Grand Rue 68830 Oderen
        <br />
        Responsable publication : Julien Dahy –
        contact@springgreen-crocodile-204519.hostingersite.com
        <br />
        Webmaster : Julien Dahy –
        contact@springgreen-crocodile-204519.hostingersite.com
        <br />
        Hébergeur : 1and1 – 7 Place de la Gare 57200 Sarreguemines 0970 808 911
        <br />
        Délégué à la protection des données : Julien DAHY –
        contact@springgreen-crocodile-204519.hostingersite.com
      </p>
      <p className="mt-2 text-xs text-zinc-400">
        Ce modèle de mentions légales est proposé par le générateur gratuit
        offert par Orson.io
      </p>
    </section>
    <section className="mb-8">
      ...
      <p>
        ...
        https://springgreen-crocodile-204519.hostingersite.com implique
        ...
        https://springgreen-crocodile-204519.hostingersite.com sont donc invités
        ...
        https://springgreen-crocodile-204519.hostingersite.com, qui s’efforcera
        alors de communiquer préalablement aux utilisateurs les dates et heures
        de l’intervention.
        <br />
        Le site web https://springgreen-crocodile-204519.hostingersite.com est
        mis à jour régulièrement par
        https://springgreen-crocodile-204519.hostingersite.com responsable. De
    ...
    <section className="mb-8">
      ...
      <p>
        Le site internet https://springgreen-crocodile-204519.hostingersite.com
        a pour objet de fournir une information concernant l’ensemble des
        activités de la société.
        <br />
        https://springgreen-crocodile-204519.hostingersite.com s’efforce de
        fournir sur le site
        https://springgreen-crocodile-204519.hostingersite.com des informations
        ...
        https://springgreen-crocodile-204519.hostingersite.com sont données à
        titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
        renseignements figurant sur le site
        https://springgreen-crocodile-204519.hostingersite.com ne sont pas
    ...
    <section className="mb-8">
      ...
      <p>
        ...
        <br />
        Le site https://springgreen-crocodile-204519.hostingersite.com est
        ...
        réputé anormal.
        <br />
        https://springgreen-crocodile-204519.hostingersite.com et l’hébergeur ne
    ...
    <section className="mb-8">
      ...
      <p>
        https://springgreen-crocodile-204519.hostingersite.com est propriétaire
        ...
        préalable de : https://springgreen-crocodile-204519.hostingersite.com.
        <br />
    ...
    <section className="mb-8">
      ...
      <p>
        https://springgreen-crocodile-204519.hostingersite.com agit en tant
        qu’éditeur du site.
        https://springgreen-crocodile-204519.hostingersite.com est responsable
        de la qualité et de la véracité du Contenu qu’il publie.
        <br />
        https://springgreen-crocodile-204519.hostingersite.com ne pourra être
        tenu responsable des dommages directs et indirects causés au matériel de
        l’utilisateur, lors de l’accès au site internet
        https://springgreen-crocodile-204519.hostingersite.com, et résultant
        ...
        incompatibilité.
        <br />
        https://springgreen-crocodile-204519.hostingersite.com ne pourra
        ...
        l’utilisation du site
        https://springgreen-crocodile-204519.hostingersite.com.
        <br />
        Des espaces interactifs (possibilité de poser des questions dans
        l’espace contact) sont à la disposition des utilisateurs.
        https://springgreen-crocodile-204519.hostingersite.com se réserve le
        ...
        https://springgreen-crocodile-204519.hostingersite.com se réserve
    ...
    <section className="mb-8">
      ...
      <p>
        ...
        responsable du traitement des Données Personnelles est : Julien Dahy.
        <br />
        https://springgreen-crocodile-204519.hostingersite.com est représenté
        par Julien Dahy, son représentant légal.
        <br />
        En tant que responsable du traitement des données qu’il collecte,
        https://springgreen-crocodile-204519.hostingersite.com s’engage à
        ...
        <br />
        Chaque fois que https://springgreen-crocodile-204519.hostingersite.com
        traite des Données Personnelles,
        https://springgreen-crocodile-204519.hostingersite.com prend toutes les
        ...
        https://springgreen-crocodile-204519.hostingersite.com les traite.
      </p>
      <h3 className="text-lg font-semibold mt-4 mb-2">
        7.2 Finalité des données collectées
      </h3>
      <p>
        https://springgreen-crocodile-204519.hostingersite.com est susceptible
        de traiter tout ou partie des données :<br />
        ...
        https://springgreen-crocodile-204519.hostingersite.com : adresse email
        <br />
        pour mener des campagnes de communication (sms, mail) : numéro de
        téléphone, adresse email
        <br />
        https://springgreen-crocodile-204519.hostingersite.com ne commercialise
      ...
      <p>
        ...
        de https://springgreen-crocodile-204519.hostingersite.com disposent des
        droits suivants :<br />
        ...
        de choisir à qui https://springgreen-crocodile-204519.hostingersite.com
        devra communiquer (ou non) ses données à un tiers qu’ils aura
        préalablement désigné
        <br />
        Dès que https://springgreen-crocodile-204519.hostingersite.com a
        connaissance du décès d’un Utilisateur et à défaut d’instructions de sa
        part, https://springgreen-crocodile-204519.hostingersite.com s’engage à
        ...
        https://springgreen-crocodile-204519.hostingersite.com utilise ses
        Données Personnelles, demander à les rectifier ou s’oppose à leur
        traitement, l’Utilisateur peut contacter
        https://springgreen-crocodile-204519.hostingersite.com par écrit à
        l’adresse suivante : Julien Dahy – DPO, Julien DAHY 46 Grand Rue 68830
        Oderen.
        <br />
        Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles qu’il
        souhaiterait que https://springgreen-crocodile-204519.hostingersite.com
        ...
        https://springgreen-crocodile-204519.hostingersite.com par la loi,
        notamment en matière de conservation ou d’archivage des documents.
        <br />
        Enfin, les Utilisateurs de
        https://springgreen-crocodile-204519.hostingersite.com peuvent déposer
      ...
      <p>
        https://springgreen-crocodile-204519.hostingersite.com s’interdit de
        ...
        <br />
        Pour autant, https://springgreen-crocodile-204519.hostingersite.com
        ...
        https://springgreen-crocodile-204519.hostingersite.com, celle-ci devra
        dans les meilleurs délais informer le Client et lui communiquer les
        mesures de corrections prises.
        <br />
        Par ailleurs https://springgreen-crocodile-204519.hostingersite.com ne
        collecte aucune « données sensibles ».
        <br />
        Les Données Personnelles de l’Utilisateur peuvent être traitées par des
        filiales de https://springgreen-crocodile-204519.hostingersite.com et
        ...
        https://springgreen-crocodile-204519.hostingersite.com sont
    ...
    <section className="mb-8">
      <h2 className="text-xl font-semibold mb-2">8. Notification d’incident</h2>
      <p>
        ...
        questions relevant de la sécurité de leur compte et à leur fournir
        ...
        https://springgreen-crocodile-204519.hostingersite.com n’est publiée à
        ...
        https://springgreen-crocodile-204519.hostingersite.com et de ses droits
        ...
        du site https://springgreen-crocodile-204519.hostingersite.com.
      </p>
    </section>
    <section className="mb-8">
      ...
      <p>
        ...
        https://springgreen-crocodile-204519.hostingersite.com utilise des
    ...
    <section className="mb-8">
      ...
      <p>
        Le site https://springgreen-crocodile-204519.hostingersite.com contient
        un certain nombre de liens hypertextes vers d’autres sites, mis en place
        avec l’autorisation de
        https://springgreen-crocodile-204519.hostingersite.com. Cependant,
        https://springgreen-crocodile-204519.hostingersite.com n’a pas la
      ...
      <p>
        ...
        https://springgreen-crocodile-204519.hostingersite.com d’améliorer le
        ...
        manière à ce que l’acceptation ou le refus des Cookies lui soient
        proposés ponctuellement, avant qu’un Cookie soit susceptible d’être
        enregistré dans son terminal.
        <br />
        https://springgreen-crocodile-204519.hostingersite.com informe
        ...
        expérience sur le Site peuvent être limitées.
        <br />
        Cela pourrait également être le cas lorsque
        https://springgreen-crocodile-204519.hostingersite.com ou l’un de ses
        ...
        connecté à Internet.
        <br />
        Le cas échéant, https://springgreen-crocodile-204519.hostingersite.com
        ...
        par https://springgreen-crocodile-204519.hostingersite.com, résultant
        (i) du refus de Cookies par l’Utilisateur (ii) de l’impossibilité pour
        https://springgreen-crocodile-204519.hostingersite.com d’enregistrer ou
        ...
        configuration de chaque navigateur est différente. Elle est décrite dans
        le menu d’aide du navigateur, qui permettra de savoir de quelle manière
        l’Utilisateur peut modifier ses souhaits en matière de Cookies.
        <br />
        À tout moment, l’Utilisateur peut faire le choix d’exprimer et de
        modifier ses souhaits en matière de Cookies.
        <br />
        https://springgreen-crocodile-204519.hostingersite.com pourra en outre
        ...
        https://springgreen-crocodile-204519.hostingersite.com ou dans son
        ...
        de https://springgreen-crocodile-204519.hostingersite.com, Twitter,
        ...
        https://springgreen-crocodile-204519.hostingersite.com dépose ce type de
        cookies.
      </p>
      <h3 className="text-lg font-semibold mt-4 mb-2">
      ...
      <p>
        https://springgreen-crocodile-204519.hostingersite.com peut employer
        ...
        https://springgreen-crocodile-204519.hostingersite.com d’évaluer les
        ...
        https://springgreen-crocodile-204519.hostingersite.com, et fournir
    ...
    <section className="mb-8">
      ...
      <p>
        ...
        https://springgreen-crocodile-204519.hostingersite.com est soumis au
